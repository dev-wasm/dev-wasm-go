...
func WasiPollPollPollOneoff(in []uint32) []uint8 {
  var lower_in C.proxy_list_wasi_poll_poll_pollable_t
  if len(in) == 0 {
    lower_in.ptr = nil
    lower_in.len = 0
  } else {
  ...
  defer C.proxy_list_wasi_poll_poll_pollable_free(&lower_in)
...
func WasiIoStreamsRead(this uint32, len uint64) Result[WasiIoStreamsTuple2ListU8TBoolT, WasiIoStreamsStreamError] {
  ...
  lower_this = lower_this_val
  lower_len := C.uint64_t(len)
  var ret C.proxy_result_tuple2_list_u8_bool_wasi_io_streams_stream_error_t
...
func WasiIoStreamsSkip(this uint32, len uint64) Result[WasiIoStreamsTuple2U64BoolT, WasiIoStreamsStreamError] {
  ...
  lower_this = lower_this_val
  lower_len := C.uint64_t(len)
  var ret C.proxy_result_tuple2_u64_bool_wasi_io_streams_stream_error_t
...
func WasiIoStreamsWrite(this uint32, buf []uint8) Result[uint64, WasiIoStreamsStreamError] {
  ...
  var ret C.proxy_result_u64_wasi_io_streams_stream_error_t
...
func WasiHttpTypesNewFields(entries []WasiHttpTypesTuple2StringListU8TT) uint32 {
  var lower_entries C.proxy_list_tuple2_string_list_u8_t
  if len(entries) == 0 {
    lower_entries.ptr = nil
    lower_entries.len = 0
  } else {
    var empty_lower_entries C.proxy_tuple2_string_list_u8_t
    lower_entries.ptr = (*C.proxy_tuple2_string_list_u8_t)(C.malloc(C.size_t(len(entries)) * C.size_t(unsafe.Sizeof(empty_lower_entries))))
    lower_entries.len = C.size_t(len(entries))
    for lower_entries_i := range entries {
      lower_entries_ptr := (*C.proxy_tuple2_string_list_u8_t)(unsafe.Pointer(uintptr(unsafe.Pointer(lower_entries.ptr)) +
      uintptr(lower_entries_i)*unsafe.Sizeof(empty_lower_entries)))
      var lower_entries_ptr_value C.proxy_tuple2_string_list_u8_t
      ...
      var lower_entries_ptr_value_f1 C.proxy_list_u8_t
  ...
  defer C.proxy_list_tuple2_string_list_u8_free(&lower_entries)
...
func WasiHttpTypesFinishIncomingStream(s uint32) Option[uint32] {
  ...
  lower_s = lower_s_val
  var ret C.proxy_option_wasi_http_types_future_trailers_t
...
func WasiHttpTypesFutureTrailersGet(f uint32) Option[Result[uint32, WasiHttpTypesError]] {
  ...
  lower_f_val := C.uint32_t(f)
  lower_f = lower_f_val
  var ret C.proxy_option_result_wasi_http_types_trailers_wasi_http_types_error_t
...
func WasiHttpTypesFutureWriteTrailersResultGet(f uint32) Option[Result[struct{}, WasiHttpTypesError]] {
  ...
  lower_f_val := C.uint32_t(f)
  lower_f = lower_f_val
  var ret C.proxy_option_result_void_wasi_http_types_error_t
...
func WasiHttpTypesIncomingRequestScheme(request uint32) Option[WasiHttpTypesScheme] {
  ...
  lower_request_val := C.uint32_t(request)
  lower_request = lower_request_val
  var ret C.proxy_option_wasi_http_types_scheme_t
...
func WasiHttpTypesIncomingRequestConsume(request uint32) Result[uint32, struct{}] {
  ...
  lower_request_val := C.uint32_t(request)
  lower_request = lower_request_val
  var ret C.proxy_result_wasi_http_types_incoming_stream_void_t
...
func WasiHttpTypesNewOutgoingRequest(method WasiHttpTypesMethod, path_with_query Option[string], scheme Option[WasiHttpTypesScheme], authority Option[string], headers uint32) uint32 {
  ...
  var lower_scheme C.proxy_option_wasi_http_types_scheme_t
  if scheme.IsSome() {
  ...
  defer C.proxy_option_wasi_http_types_scheme_free(&lower_scheme)
...
func WasiHttpTypesOutgoingRequestWrite(request uint32) Result[uint32, struct{}] {
  ...
  lower_request_val := C.uint32_t(request)
  lower_request = lower_request_val
  var ret C.proxy_result_wasi_http_types_outgoing_stream_void_t
...
func WasiHttpTypesSetResponseOutparam(param uint32, response Result[uint32, WasiHttpTypesError]) Result[struct{}, struct{}] {
  ...
  var lower_response C.proxy_result_wasi_http_types_outgoing_response_wasi_http_types_error_t
  ...
  defer C.proxy_result_wasi_http_types_outgoing_response_wasi_http_types_error_free(&lower_response)
...
func WasiHttpTypesFutureIncomingResponseGet(f uint32) Option[Result[uint32, WasiHttpTypesError]] {
  ...
  lower_f_val := C.uint32_t(f)
  lower_f = lower_f_val
  var ret C.proxy_option_result_wasi_http_types_incoming_response_wasi_http_types_error_t
...
func WasiHttpOutgoingHandlerHandle(request uint32, options Option[WasiHttpTypesRequestOptions]) uint32 {
  ...
  lower_request = lower_request_val
  var lower_options C.proxy_option_wasi_http_outgoing_handler_request_options_t
  if options.IsSome() {
