...
typedef struct {
  ...
  size_t len;
} proxy_list_wasi_poll_poll_pollable_t;
...
} proxy_result_tuple2_list_u8_bool_wasi_io_streams_stream_error_t;
...
} proxy_result_tuple2_u64_bool_wasi_io_streams_stream_error_t;
...
} proxy_result_u64_wasi_io_streams_stream_error_t;
...
} proxy_option_wasi_http_types_future_trailers_t;
...
} proxy_result_wasi_http_types_trailers_wasi_http_types_error_t;

typedef struct {
  bool is_some;
  proxy_result_wasi_http_types_trailers_wasi_http_types_error_t val;
} proxy_option_result_wasi_http_types_trailers_wasi_http_types_error_t;
...
} proxy_result_void_wasi_http_types_error_t;

typedef struct {
  bool is_some;
  proxy_result_void_wasi_http_types_error_t val;
} proxy_option_result_void_wasi_http_types_error_t;
...
} proxy_option_wasi_http_types_scheme_t;
...
} proxy_result_wasi_http_types_incoming_stream_void_t;
...
} proxy_result_wasi_http_types_outgoing_stream_void_t;
...
} proxy_result_wasi_http_types_outgoing_response_wasi_http_types_error_t;
...
} proxy_result_wasi_http_types_incoming_response_wasi_http_types_error_t;

typedef struct {
  bool is_some;
  proxy_result_wasi_http_types_incoming_response_wasi_http_types_error_t val;
} proxy_option_result_wasi_http_types_incoming_response_wasi_http_types_error_t;
...
} proxy_option_wasi_http_outgoing_handler_request_options_t;
